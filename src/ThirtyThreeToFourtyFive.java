...
public class ThirtyThreeToFourtyFive {
    public static void main(String[] args) {
        ...
        ThirtyThreeToFourtyFive m = new ThirtyThreeToFourtyFive();
        m.findDup(dupArray);
        ...
        exceptionHandle(2, 1);
        duplicateWords("abc abc def def");
        storeNames();
    }
    ...
    public static void storeNames() {
        try {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                file.write("Address: " + address + newLine);
            }
            file.close();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void duplicateWords(String sentenceI) {
        ...
        try {
            ...
            FileWriter file = new FileWriter(filePath);
            file.write(sentenceI + newLine);
            int count;
            String[] sen = sentenceI.split("");
